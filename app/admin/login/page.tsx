...
function AdminLoginForm() {
  ...
  const [error, setError] = useState(unauthorized ? 'You do not have admin access.' : '');
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input type="email" value={email} onChange={e => setEmail(e.target.value)} required className="w-full border border-slate-300 rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-brand-500 outline-none" placeholder="admin@example.com" />
          </div>
          <div>
