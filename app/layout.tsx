        ...
        <nav className="bg-white border-b border-slate-200 sticky top-0 z-50">
          <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <a href="/" className="text-sm text-slate-600 hover:text-brand-600 transition-colors">Book a Session</a>
              <a href="/my-bookings" className="text-sm text-slate-600 hover:text-brand-600 transition-colors">My Bookings</a>
              <a href="/login" className="text-sm bg-brand-600 text-white px-4 py-1.5 rounded-full hover:bg-brand-700 transition-colors">Sign In</a>
            </div>
          </div>
        </nav>
        <main>{children}</main>
